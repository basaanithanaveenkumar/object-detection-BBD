...
model = RFDETRBase(resolution=560,num_classes=10,pretrain_weights = "/home/basaanithanaveenkumar/object-detection-BBD/experiments/v1/checkpoint0002.pth") # resolution shoud be divisible by 56
if __name__ == '__main__':
    import multiprocessing
    multiprocessing.set_start_method('spawn', force=True)
    #model.train(dataset_dir="data/100k", epochs=0, batch_size=64, grad_accum_steps=4, lr=1e-4, output_dir="experiments/v1",checkpoint_interval=1,num_workers=8,class_names=["car","traffic sign","traffic light","person","truck","bus","bike","rider","motor","train"])
    ...
    # plot the loss graphs, precision and recall scores
    #Image.open("/content/output/metrics_plot.png")

    ds = sv.DetectionDataset.from_coco(
        images_directory_path="data/100k/valid/",
        annotations_path="data/100k/valid/_annotations.coco.json",
    )
    ...
    plt.savefig("images/detections_vs_annotation.png", bbox_inches='tight')
    ...
    plt.savefig("images/detections_grid.png", bbox_inches='tight')
    #evaluation of model
    targets = []
    predictions = []
    ...
    map_result.plot()
    plt.savefig("images/mAP_scores_Eval.png", bbox_inches='tight')

    #plot the confession matrix
    ...
    plt.savefig("images/confession_matirx_eval.png", bbox_inches='tight')